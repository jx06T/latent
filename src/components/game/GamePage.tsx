...
export default function GamePage() {
  const { accessToken, user, loading: authLoading, isLoggedIn, signIn } = useSupabaseAuth()
      ...
      {gameState === 'loading' ? (
        ...
        <div className="min-h-screen font-mono p-4 md:p-8">
          <main className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-12 gap-6">
            {/* 左側：研究終端與解題介面 */}
            <div className="sm:col-span-8 border border-line bg-bg-surface/50 overflow-hidden shadow-2xl">
